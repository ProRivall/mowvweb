...
export default function MowvExperience() {
  ...
  return (
    ...
    >
      ...
      <main>
        <HeroSection colors={colors} heroVisible={heroVisible} mousePosition={mousePosition} />
        <MarqueeStrip text="BUILT IN MOTION" colors={colors} motionEnabled={motionEnabled} hoverPause />
        <AboutSection colors={colors} isMobile={isMobile} />
        <MarqueeStrip text="THE STREETS DON'T WAIT" colors={colors} motionEnabled={motionEnabled} />
        <StoriesSection
          colors={colors}
